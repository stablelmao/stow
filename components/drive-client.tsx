...
export function DriveClient({ blobConfigured }: { blobConfigured: boolean }) {
  ...
  }, [blobConfigured, getToken, isSignedIn]);
  ...
  const live = blobConfigured && Boolean(userId);
  ...
  return (
    <main className="drive-page">
      ...
      <div className="drive-main container">
        ...
        {!blobConfigured && <div className="setup-banner"><b>STORAGE SETUP</b><span>Connect Vercel Blob to activate uploads.</span></div>}
